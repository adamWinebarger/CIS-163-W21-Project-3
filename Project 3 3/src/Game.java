...
public class Game extends Rental {
    ...
    public Consol3 getConsole() {
        return console;
    }

    public void setConsole(Consol3 console) {
        this.console = console;
    }
    ...
    public double getCost(GregorianCalendar dueBack) {
        ...
        double cost = 0;
        if (console != null) {
            Consol3 temp = new Consol3(this.nameOfRenter, rentedOn, this.dueBack, actualDateReturned, console.getConsoleType());
